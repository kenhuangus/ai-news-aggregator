...
> **AATF Quick Win** · Multi-agent AI news pipeline powered by Claude Opus 4.6 with extended thinking

## [https://news.aatf.ai](https://news.aatf.ai)
...
| **Type** | Quick Win |
| **Status** | Production |
| **Maintainer** | AI Acceleration Task Force |
| **Contact** | [AllofTrendAATF@trendmicro.com](mailto:AllofTrendAATF@trendmicro.com) |

This repository contains the pipeline source code. Teams wanting to run their own instance or customize the pipeline can use the instructions below.
...
To contribute or request features, contact [AllofTrendAATF@trendmicro.com](mailto:AllofTrendAATF@trendmicro.com).

For bugs and issues, please [open an issue](https://github.com/trend-ai-acceleration-task-force/ai-news-aggregator/issues) on GitHub.
...
**AI Acceleration Task Force** | [trend-ai-acceleration-task-force](https://github.com/trend-ai-acceleration-task-force)

*Accelerating AI delivery across TrendAI through rapid prototyping and pattern extraction.*
